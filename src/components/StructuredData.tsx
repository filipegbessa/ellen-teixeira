...
export default function StructuredData() {
  const structuredData = {
    ...
    "description": businessInfo.professional.title + ". Atendimento odontológico personalizado e humanizado no Rio de Janeiro.",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": businessInfo.address.street + (businessInfo.address.complement ? `, ${businessInfo.address.complement}` : ''),
    ...
    "priceRange": "$$",
    "openingHoursSpecification": businessInfo.businessHours.openingHours.map(hours => ({
    ...
    "sameAs": [
      businessInfo.contact.social.instagram.url
    ],
